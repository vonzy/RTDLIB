...
//            ObservationsProvider roverIn =  ParserFactory.produceRinexObsProvider(new File("./data/07590920.05o"));
//            NavigationProvider navigationIn = ParserFactory.produceRinexNavProvider(new File("./data/07590920.05n"));
            ...
            Rtdlib rtdlib = new Rtdlib(navigationIn,roverIn);
